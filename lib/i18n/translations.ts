...
const en = {
  ...
  experienceInfo: {
    ...
    priceInclusiveOfGst: "Price is inclusive of GST",
...
const hi: TranslationDict = {
  ...
  experienceInfo: {
    ...
    priceInclusiveOfGst: "कीमत में जीएसटी शामिल है",
...
const gu: TranslationDict = {
  ...
  experienceInfo: {
    ...
    priceInclusiveOfGst: "કિંમતમાં જીએસટીનો સમાવેશ થાય છે",
...
const ta: TranslationDict = {
  ...
  experienceInfo: {
    ...
    priceInclusiveOfGst: "விலையில் ஜிஎஸ்டி சேர்க்கப்பட்டுள்ளது",
